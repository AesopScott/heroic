    ...
    public static class PrototypeDraftChoices
    {
        public static UpgradeManager.DraftChoice[] Create()
        {
            return new[]
            {
                ...
                Skill("lightning_static_field", "Static Field", "Unlock charged zones with stun pressure.", UpgradeManager.AbilityType.AreaOfEffectGround),
                Skill("lightning_thunder_lance", "Thunder Lance", "Unlock a piercing Lightning line strike.", UpgradeManager.AbilityType.Line),
                Skill("lightning_spark_surge", "Spark Surge", "Unlock rapid Lightning burst fire.", UpgradeManager.AbilityType.NearestEnemy),
                ...
                Skill("mind_confuse", "Confuse", "Unlock enemy behavior disruption.", UpgradeManager.AbilityType.AreaOfEffectEnemy),
                ...
                Skill("poison_poison_dart", "Poison Dart", "Unlock venom projectiles.", UpgradeManager.AbilityType.Projectile),
                ...
                Skill("poison_rot_bloom", "Rot Bloom", "Unlock toxic burst and decay.", UpgradeManager.AbilityType.AreaOfEffectEnemy),
                ...
                System("system_component_boosts", "Component Boosts", "Gather spell components that empower and modify casting."),
                ...
                System("system_sacrifice_casting", "Sacrifice Casting", "Trade health and safety for stronger spell output."),
