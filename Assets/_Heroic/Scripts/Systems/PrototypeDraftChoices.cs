    ...
    public static class PrototypeDraftChoices
    {
        public static UpgradeManager.DraftChoice[] Create()
        {
            return new[]
            {
                ...
                Skill("fire_flame_shield", "Flame Shield", "Unlock a protective fire aura that burns nearby enemies."),
                Skill("fire_flame_wall", "Flame Wall", "Unlock a lingering wall of fire across enemy paths."),
