    ...
    public static class PrototypeDraftChoices
    {
        public static UpgradeManager.DraftChoice[] Create()
        {
            return new[]
            {
                ...
                Skill("fire_incinerate", "Incinerate", "Details pending Skills session."),
                Skill("fire_inferno", "Inferno", "Details pending Skills session."),
                Skill("fire_phoenix", "Phoenix", "Details pending Skills session."),
                ...
                Skill("cold_blizzard", "Blizzard", "Details pending Skills session."),
                Skill("cold_frostbite", "Frostbite", "Details pending Skills session."),
                Skill("cold_cryostasis", "Cryostasis", "Details pending Skills session."),
                ...
                Skill("lightning_ball_lightning", "Ball Lightning", "Details pending Skills session."),
                Skill("lightning_conductor", "Conductor", "Details pending Skills session."),
                Skill("lightning_fork", "Fork", "Details pending Skills session."),
                ...
                Skill("earth_quicksand", "Quicksand", "Details pending Skills session."),
                Skill("earth_brambles", "Brambles", "Details pending Skills session."),
                Skill("earth_swarm", "Swarm", "Details pending Skills session."),
                ...
                Skill("mind_telekinesis", "Telekinesis", "Details pending Skills session."),
                Skill("mind_push", "Push", "Details pending Skills session."),
                Skill("mind_mass_charm", "Mass Charm", "Details pending Skills session."),
                ...
                Skill("blood_drain_life", "Drain Life", "Details pending Skills session."),
                Skill("blood_blood_boil", "Blood Boil", "Details pending Skills session."),
                Skill("blood_exsanguinate", "Exsanguinate", "Details pending Skills session."),
                ...
                Skill("poison_disintegrate", "Disintegrate", "Details pending Skills session."),
                Skill("poison_poison_cloud", "Poison Cloud", "Details pending Skills session."),
                Skill("poison_disease", "Disease", "Details pending Skills session."),
