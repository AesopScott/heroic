...
namespace Heroic.Editor
{
    public static class HeroicReadinessValidator
    {
        ...
        public static ValidationSummary ValidatePrototypeContent()
        {
            ...
            ValidatePrefab<EnemyController>(Root + "/Prefabs/Enemies/Enemy_Basic.prefab", "basic enemy prefab", ref errors);
            ValidatePrefabComponents(Root + "/Prefabs/Enemies/Enemy_Basic.prefab", "basic enemy prefab", ref errors, typeof(Damageable), typeof(VisualPresetApplier), typeof(HitFlashVisual), typeof(DeathBurstVisual), typeof(WorldHealthBar), typeof(DamageNumberEmitter), typeof(AudioSource), typeof(ProceduralAudioFeedback));
            ...
            ValidateEnemyDefinition(Root + "/ScriptableObjects/Enemies/Enemy_Basic.asset", "basic enemy definition", VisualPresetApplier.Preset.BasicEnemy, ref errors);
            ValidateEnemyDefinition(Root + "/ScriptableObjects/Enemies/Enemy_Fast.asset", "fast enemy definition", VisualPresetApplier.Preset.FastEnemy, ref errors);
            ValidateEnemyDefinition(Root + "/ScriptableObjects/Enemies/Enemy_Tank.asset", "tank enemy definition", VisualPresetApplier.Preset.TankEnemy, ref errors);
